...
wget "https://raw.githubusercontent.com/Doridian/docker-sriov-plugin/$VERSION/docker-sriov-plugin.service" -O /etc/systemd/system/docker-sriov-plugin.service
